...
public class ToastMsg {
    ...
    //登录接口
    public static String showLoginMsg(String key, String msg) {
        if (key.equals("000")) {
            return "账号或密码错误";
    ...
    //注册接口
    public static String showRegisterMsg(String key, String msg) {
        if (key.equals("110")) {
            return "服务器错误";
    ...
    //注销接口
    public static String showLogoutMsg(String key,String msg){
        if (key.equals("000")){
            return "账号或密码错误";
        }else if (key.equals("00")){
            return "sign参数错误";
