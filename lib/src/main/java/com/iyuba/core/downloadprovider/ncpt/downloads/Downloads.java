...
public final class Downloads implements BaseColumns {
     ...
     */
//    public static final String AUTHORITY = CrashApplication.getInstance().getApplicationInfo().packageName+
//            ".com.iyuba.core.downloadprovider.ncpt.downloads";

    public static final String AUTHORITY = CrashApplication.getAUTHORITY();
