...
public class DownloadManagerProxy {
	...
	public boolean addDownload(int voaId, String url) {
		if(idMap.get(voaId) != null) {
			...
			request.setDestinationInExternalPublicDir("/"+ "/iyuba/"+Constant.AppName+"2/res", "/");
			request.setDescription(Constant.AppName + "2");
	...
	public boolean addDownloadAll(int voaId, String urlZip,String urlVideo) {
		if(idMap.get(voaId) != null) {
			...
			requestZip.setDestinationInExternalPublicDir("/"+ "/iYuba/"+Constant.AppName+"2/res", "/");
			requestZip.setDescription(Constant.AppName + "2");
