...
public class DownloadService extends Service {
    ...
    public void initNotification() {
        ...
        if (Build.VERSION.SDK_INT > 26) {
            notificationManager.createNotificationChannel(new NotificationChannel("223", "223", NotificationManager.IMPORTANCE_LOW));
            Notification notification = new Notification.Builder(this, "223")
                    .setOngoing(true)
                    .setContentTitle("新概念英语")
                    .setContentText("快来学习新概念英语吧~")
                    .setSmallIcon(R.drawable.icon_lib)
                    .setTicker("快来学习新概念英语吧~")
                    .setAutoCancel(true)
                    .build();
            startForeground(223, notification);
        } else {
            Notification.Builder localBuilder = new Notification.Builder(this);
            localBuilder.setOngoing(true).setContentTitle("新概念英语")
                    .setContentText("快来学习新概念英语吧~")
                    .setSmallIcon(R.drawable.icon_lib)
                    .setTicker("快来学习新概念英语吧~")
                    .setAutoCancel(true);

            startForeground(223, localBuilder.build());
        }
    }
