...
public class CommentListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		GitHubImageLoader.getInstance().setPic(comment.userimg, viewHolder.userIcon,R.drawable.noavatar_small);
...
//				playVoice("http://www." + Constant.IYUBA_CN + "question/" + comment.answer);// 播放
				playVoice("http://www." + Constant.IYUBA_CN + "question/" + comment.audio);// 播放
