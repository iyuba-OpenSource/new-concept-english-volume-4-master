...
public class ChatAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (String.valueOf(UserInfoManager.getInstance().getUserId()).equals(info.uid + "")
        ...
        GitHubImageLoader.getInstance().setCirclePic(info.timg + "", holder.answerImage, R.drawable.noavatar_small);
        ...
        if (chat.type == 1) {
            ...
            holder.otherContent.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    playVoice("http://www." + Constant.IYUBA_CN + "question/" + chat.content);// 播放
...
//                mContext.startActivity(intent);
                ...
                mContext.startActivity(PersonalHomeActivity.buildIntent(mContext, info.uid, info.username, 0));
        ...
        if (checkAgree("a" + info.answerid, String.valueOf(UserInfoManager.getInstance().getUserId())) == 1) {
            holder.agree_icon.setBackgroundResource(R.drawable.agree_press_line);
            holder.agreeText.setText("" + info.agreeCount + "");
        } else {
