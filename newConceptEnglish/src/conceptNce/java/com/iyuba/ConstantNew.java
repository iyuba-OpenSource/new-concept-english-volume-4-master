...
public class ConstantNew  {
	...
	public static final String PACK_NAME= "com.iyuba.nce";

	//升级需要的类型
	public static final String PACKAGE_TYPE = "nce";
	...
	/*********广告*********/
	public static final String SDK_SPLASH_CODE = "";
	public static final String SDK_BANNER_CODE = "";
	...
	/****oaid升级****/
	//oaid的证书名称
	public static final String oaid_pem = "com.iyuba.nce.cert.pem";
