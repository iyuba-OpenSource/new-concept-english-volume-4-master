...
public class ConstantNew  {
	...
	public static final String PACK_NAME= "com.iyuba.newconcepttop";

	//升级需要的类型
	public static final String PACKAGE_TYPE = "newconcepttop";
	...
	/*********广告*********/
	public static final String SDK_SPLASH_CODE = "0017";
	public static final String SDK_BANNER_CODE = "0018";
	...
	/****oaid升级****/
	//oaid的证书名称
	public static final String oaid_pem = "com.iyuba.newconcepttop.cert.pem";
