...
public class EvaluateBean {
     ...
     * word_count : 5
     * URL : http://"+Constant.userSpeech + Constant.IYUBA_CN + "data/projects/speech/wav/concept/549278710051005.wav
    ...
    public EvaluateBean(String sentence, String total_score, int word_count, String URL, List<WordsBean> words) {
    ...
    public static class WordsBean {
        public WordsBean(String content, int index, double score) {
