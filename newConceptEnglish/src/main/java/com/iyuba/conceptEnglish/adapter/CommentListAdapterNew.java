...
public class CommentListAdapterNew extends RecyclerView.Adapter<CommentListAdapterNew.MyViewHolder> {
...
//    private MediaPlayer videoView;
    ...
    public CommentListAdapterNew(Context context, int type) {
        mContext = context;
        //mList = Comments;
...
//        this.videoView = videoView;
    ...
    public CommentListAdapterNew(Context context,int type, OnItemClickListener onItemClickListener) {
        mContext = context;
        //mList = Comments;
        uid = String.valueOf(UserInfoManager.getInstance().getUserId());
        this.type = type;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        try {
            if (textDetailTemp != null && curItem.shuoshuoType == 2) {
                ...
                String sentence = textDetailTemp.get(curItem.index - 1).sentence.toString().trim();
