...
public class MultipleChoiceActivity extends BasisActivity {
    ...
    private void initMultipleChoice() {
        ...
        recyclerView = (ListView) findViewById(R.id.result_listview);//成绩列表
        //设置RecyclerView管理器
        ...
        startExercise = (ImageView) findViewById(R.id.start_exercise);

        circleProgress = (RoundProgressBar) findViewById(R.id.result_round_bar);

        rightRateValueText = (TextView) findViewById(R.id.right_rate_value);
        spendTimeValueText = (TextView) findViewById(R.id.test_spendtime_value);
        questionNumValueText = (TextView) findViewById(R.id.question_sum_value);

        rightRateText = (TextView) findViewById(R.id.right_rate);
        spendTimeText = (TextView) findViewById(R.id.test_spendtime);
        questionNumText = (TextView) findViewById(R.id.question_sum);
        question_index = (TextView) findViewById(R.id.question_index); //题号

        pageIndicator = (ExercisePageIndicator) findViewById(R.id.pageIndicator);
        testTypeTextView = (TextView) findViewById(R.id.test_type);
        questionTextView = (TextView) findViewById(R.id.question_body);
        answerAIcon = (TextView) findViewById(R.id.answer_a_icon);
        answerBIcon = (TextView) findViewById(R.id.answer_b_icon);
        answerCIcon = (TextView) findViewById(R.id.answer_c_icon);
        answerDIcon = (TextView) findViewById(R.id.answer_d_icon);
        answerAText = (TextView) findViewById(R.id.answer_a_text);
        answerBText = (TextView) findViewById(R.id.answer_b_text);
        answerCText = (TextView) findViewById(R.id.answer_c_text);
        answerDText = (TextView) findViewById(R.id.answer_d_text);
        ...
        formerQuestionButton = (TextView) findViewById(R.id.former_question_button);
        nextQuestionButton = (TextView) findViewById(R.id.next_question_button);
        exerciseResult = (TextView) findViewById(R.id.result);
        backButton = (ImageView) findViewById(R.id.back);
        resultTextViews = (ResultTextViews) findViewById(R.id.result_textviews);
...
//                        answerDIcon.setTextColor(Color.WHITE);
    ...
    public void makeResult() {
        if (!UserInfoManager.getInstance().isLogin()) {
            ...
            for (int i = 0; i < questionNum; i++) {
                ...
                exerciseRecord.uid = Integer.valueOf(uid);
    ...
    void refreshQuestion() {
        if (questionNum > 0) {
            // 显示题型和问题
            MultipleChoice multipleChoice = multipleChoiceMap
                    .get(curQuestionId);
