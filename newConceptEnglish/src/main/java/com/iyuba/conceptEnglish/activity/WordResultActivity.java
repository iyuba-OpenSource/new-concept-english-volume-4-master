...
import com.iyuba.conceptEnglish.protocol.WordResultRequest;
import com.iyuba.conceptEnglish.protocol.WordResultResponse;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				finish();
				Log.d("退出显示25", this.getClass().getName());
			}
		});
