//package com.iyuba.conceptEnglish.lil.fix.common_fix.view.dialog.searchWord;
//
...
//import com.iyuba.conceptEnglish.databinding.DialogWordSearchBinding;
...
//    }
//
//    public SearchWordDialog(@NonNull Context context, String word,OnWordCollectCallBack onWordCollectCallBack) {
//        super(context);
//        this.context = context;
//        this.word = word;
//        this.onWordCollectCallBack = onWordCollectCallBack;
//    }
//
//    @Override
...
//        Word localWord = wordOp.findDataByName(word, String.valueOf(UserInfoManager.getInstance().getUserId()));
//        return localWord!=null;
//    }
//
//    //收藏单词
...
//
//                    //保存在临时的数据
//                    if (onWordCollectCallBack!=null){
//                        VoaWord2 word2 = new VoaWord2();
//                        word2.word = newWord.key;
//                        word2.pron = newWord.pron;
//                        word2.def = newWord.def;
//                        word2.audio = newWord.audioUrl;
//
//                        onWordCollectCallBack.onCollect(detail.key,word2);
//                    }
//
//                    binding.collect.setImageResource(R.drawable.ic_word_collected);
//                }else {
...
//                    //从临时数据中删除
//                    if (onWordCollectCallBack!=null){
//                        onWordCollectCallBack.onCollect(detail.key,null);
//                    }
//
//                    binding.collect.setImageResource(R.drawable.ic_word_nocollect);
//                }
...
//
//    //回调数据
//    public OnWordCollectCallBack onWordCollectCallBack;
//
//    public interface OnWordCollectCallBack{
//        void onCollect(String word,VoaWord2 word2);
//    }
//
//    public void setOnWordCollectCallBack(OnWordCollectCallBack onWordCollectCallBack) {
//        this.onWordCollectCallBack = onWordCollectCallBack;
//    }
//}
