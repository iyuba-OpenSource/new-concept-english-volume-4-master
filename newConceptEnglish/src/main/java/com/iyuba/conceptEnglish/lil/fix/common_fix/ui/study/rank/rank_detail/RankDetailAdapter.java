...
import com.iyuba.conceptEnglish.databinding.ItemFixRankDetailBinding;
...
public class RankDetailAdapter extends RecyclerView.Adapter<RankDetailAdapter.RankDetailHolder> {
    ...
    public RankDetailHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemFixRankDetailBinding binding = ItemFixRankDetailBinding.inflate(LayoutInflater.from(context),parent,false);
    ...
    public void onBindViewHolder(@NonNull RankDetailHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (detailBean.getShuoshuotype()==4){
            holder.index.setBackgroundResource(R.drawable.ic_bg_select_green);
            holder.index.setText("合成");
        }else if (detailBean.getShuoshuotype()==2){
            holder.index.setBackgroundResource(R.drawable.ic_bg_select_blue);
        ...
        holder.audio.setImageResource(R.drawable.ic_play_3);
        ...
        if (agreeData!=null){
            holder.agreePic.setImageResource(R.drawable.ic_agree_press);
        }else {
            holder.agreePic.setImageResource(R.drawable.ic_agree);
        }
    ...
    class RankDetailHolder extends RecyclerView.ViewHolder{
        ...
        public RankDetailHolder(ItemFixRankDetailBinding binding){
            super(binding.getRoot());

            userPic = binding.userPic;
            userName = binding.userName;
            audio = binding.userAudio;
            itemTime = binding.itemTime;
            index = binding.index;
            sentence = binding.sentence;

            score = binding.score;
            agreePic = binding.agreePic;
            agreeText = binding.agreeText;
            share = binding.sharePic;
        }
    }
    ...
    public void refreshPlayAnim(boolean isPlay){
        ...
        if (isPlay){
            ...
            selectHolder.audio.setImageResource(R.drawable.ic_play_3);
        }
    }
