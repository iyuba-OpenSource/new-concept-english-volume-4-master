package com.iyuba.conceptEnglish.lil.fix.common_fix.ui.ad.show.banner;
...
import com.iyuba.conceptEnglish.lil.fix.common_fix.ui.ad.AdDataUtil;
        ...
        try {
            youDaoNative = new YouDaoNative(context, getBannerAdKey(AdShowUtil.NetParam.AdType.show_youdao), new YouDaoNative.YouDaoNativeNetworkListener() {
                ...
                public void onNativeLoad(NativeResponse nativeResponse) {
                    ...
                    params.height = ScreenUtils.getScreenWidth(context)*7/40;
