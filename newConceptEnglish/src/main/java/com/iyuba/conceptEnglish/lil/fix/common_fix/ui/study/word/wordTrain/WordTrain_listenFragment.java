...
import com.iyuba.conceptEnglish.databinding.FragmentWordTrainListenBinding;
 ...
 * @description:
 */
public class WordTrain_listenFragment extends BaseViewBindingFragment<FragmentWordTrainListenBinding> implements WordBreakView {
     ...
     * @return
     */
    public static WordTrain_listenFragment getInstance(String types, String bookId, String id){
