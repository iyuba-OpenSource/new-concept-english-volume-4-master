 ...
 * @description:
 */
public class CnToEnAdapter extends RecyclerView.Adapter<CnToEnAdapter.WordBreakHolder> {
    ...
    public CnToEnAdapter(Context context, List<WordBean> list) {
    ...
    public void onBindViewHolder(@NonNull WordBreakHolder holder, int position) {
        ...
        if (wordBean.getWord().equals(showWord)){
            holder.desc.setBackgroundResource(R.drawable.bg_option_right);
        }else {
            if (selectIndex==position){
                holder.desc.setBackgroundResource(R.drawable.bg_option_wrong);
            }else {
                holder.desc.setBackgroundResource(R.drawable.bg_option_white);
            }
        }
