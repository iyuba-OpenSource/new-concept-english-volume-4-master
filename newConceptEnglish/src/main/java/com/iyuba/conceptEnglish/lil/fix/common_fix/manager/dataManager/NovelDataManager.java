...
import com.iyuba.conceptEnglish.lil.fix.common_fix.model.remote.base.BaseBean_novelChapter;
...
import com.iyuba.conceptEnglish.lil.fix.common_fix.model.remote.bean.Novel_chapter;
...
import com.iyuba.conceptEnglish.lil.fix.common_fix.model.remote.newService.NovelService;
...
public class NovelDataManager {
    ...
    public static Observable<Publish_eval> publishSingleEval(String bookType,String voaId,String paraId,String idIndex,int score,String content){
        ...
        NovelService novelService = RemoteManager.getInstance().createJson(NovelService.class);
        return novelService.publishSingleEval(topic,platform,protocol,format,uid,voaId,userName,shuoshuotype,paraId,idIndex,score,content);
    }
    ...
    public static Observable<Publish_eval> publishMargeEval(String bookType,String voaId, String content){
        ...
        NovelService novelService = RemoteManager.getInstance().createJson(NovelService.class);
        return novelService.publishMargeAudio(topic,platform,protocol,format,uid,voaId,shuoshuotype,avgScore,content,appId,rewardVersion);
    }
