 ...
 */
@Entity(primaryKeys = {"types","bookId","voaId","position","sentence","uid"})
public class EvalEntity_word {
    ...
    @Ignore
    public EvalEntity_word(@NonNull String types, @NonNull String bookId, @NonNull String voaId, @NonNull String position, @NonNull String sentence, String totalScore, String url, String words, String id, String localPath, String uid) {
        this.types = types;
        this.bookId = bookId;
        this.voaId = voaId;
