 ...
 * @description:
 */
public class NovelBgPlaySession {
    private static NovelBgPlaySession instance;

    public static NovelBgPlaySession getInstance(){
        if (instance==null){
            synchronized (NovelBgPlaySession.class){
                if (instance==null){
                    instance = new NovelBgPlaySession();
                }
            }
        }
        return instance;
