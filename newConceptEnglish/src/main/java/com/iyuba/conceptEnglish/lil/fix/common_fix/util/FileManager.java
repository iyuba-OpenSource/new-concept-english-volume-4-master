...
public class FileManager {
    ...
    public String dirPath(){
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.N){
            ...
            return Environment.getExternalStorageDirectory().getPath()+"/"+ Constant.AppName;
        }
    }
    ...
    public String getFixWordEvalAudioPath(String types,String voaId,String paraId,String idIndex,String wordId,long userId){
        String name = "eval_"+voaId+"_"+paraId+"_"+idIndex+"_"+wordId+TypeLibrary.FileType.MP3;
        return dirPath()+"/"+DIR_WORD+"/"+types+"/"+voaId+"/"+DIR_EVAL+"/"+userId+"/"+name;
    }
