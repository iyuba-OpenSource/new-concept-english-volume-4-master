 ...
 * @description:
 */
public class CnToEnFragment extends BaseViewBindingFragment<FragmentWordBreakBinding> {

    private String bookType;
    private String bookId;
    private String id;

    private CnToEnPresenter presenter;
    private CnToEnAdapter breakAdapter;
    ...
    public static CnToEnFragment getInstance(String bookType, String bookId, String id){
        CnToEnFragment fragment = new CnToEnFragment();
...
//        presenter.attachView(this);
    ...
    private void initList(){
        ...
        breakAdapter = new CnToEnAdapter(getActivity(),new ArrayList<>());
    ...
    private void refreshData(){
        ...
        binding.word.setText(refreshPair.first.getDef());
    ...
    private void showDialog(){
        ...
        //根据结果显示
        if (rightCount>=showWordList.size()){
