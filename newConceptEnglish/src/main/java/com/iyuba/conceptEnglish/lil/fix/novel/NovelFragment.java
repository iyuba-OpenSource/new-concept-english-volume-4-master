package com.iyuba.conceptEnglish.lil.fix.novel;
...
import com.iyuba.conceptEnglish.lil.fix.novel.main.NovelListFragment;
...
public class NovelFragment extends BaseViewBindingFragment<LayoutContainerTabTitleBinding> {
    ...
    private void initToolbar(){
        binding.toolbar.title.setText(NovelBookChooseManager.getInstance().getBookName());
