...
//                oldChapterIndex = showTitle;
        ...
        String titleEn = chapterName.replace("\r\n","").trim();
        holder.titleView.setText(HelpUtil.transTitleStyle(titleEn));
    ...
    //回调
    private OnSimpleClickListener<Pair<Integer,BookChapterBean>> listener;
