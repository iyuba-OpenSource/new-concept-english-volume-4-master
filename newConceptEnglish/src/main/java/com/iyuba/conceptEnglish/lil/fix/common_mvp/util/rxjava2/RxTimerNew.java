package com.iyuba.conceptEnglish.lil.fix.common_mvp.util.rxjava2;
 ...
 */
public class RxTimerNew {
    private static RxTimerNew instance;

    public static RxTimerNew getInstance(){
        if (instance==null){
            synchronized (RxTimerNew.class){
                if (instance==null){
                    instance = new RxTimerNew();
                }
            }
        }
        return instance;
