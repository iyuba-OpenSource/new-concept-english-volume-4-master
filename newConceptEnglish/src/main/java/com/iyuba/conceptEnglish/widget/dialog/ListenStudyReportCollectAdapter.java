 ...
 * @description:
 */
public class ListenStudyReportCollectAdapter extends RecyclerView.Adapter<ListenStudyReportCollectAdapter.AllHolder> {

    private Context context;
    private List<VoaWord2> list;

    public ListenStudyReportCollectAdapter(Context context, List<VoaWord2> list) {
