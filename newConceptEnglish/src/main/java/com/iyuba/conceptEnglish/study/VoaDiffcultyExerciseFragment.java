...
public class VoaDiffcultyExerciseFragment extends Fragment {
    public static VoaDiffcultyExerciseFragment instance;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.voa_diffculty_exercise, container, false);
        }
...
//				break;
    ...
    public void refreshBlankFilling() {
        ...
        if (describeList != null && describeList.size() > 0 && curDescribeId > -1) {
