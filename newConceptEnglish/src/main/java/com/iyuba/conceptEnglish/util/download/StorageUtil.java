package com.iyuba.conceptEnglish.util.download;
...
public class StorageUtil {
    ...
    public static File getWordZipDir(Context context) {
        return BaseStorageUtil.getDir(context, "childWords/");
    }

    public static File getWordDir(Context context) {
        return BaseStorageUtil.getDir(context, "childWords/"+context.getResources().getString(R.string.wordpath));
    }
    ...
    public static File getMediaDir(Context context, String bookId, String unitId) {
        return BaseStorageUtil.getDir(context, String.valueOf(bookId+ File.separator+unitId));
    }
    ...
    public static File getImageUnzipDir(Context context, String bookId) {
        return BaseStorageUtil.getDir(context, bookId);
    }
    ...
    public static String getAudioFilename(String voaId) {
        return voaId + MP3_SUFFIX;
    }
    ...
    public static boolean isAudioExist(String dir, String voaId) {
        return new File(dir, getAudioFilename(voaId)).exists();
    }

    public static void isAudioExistDel(String dir, String voaId) {
         new File(dir, getAudioFilename(voaId)).delete();
    }
    ...
    public static void delVideoClipExist(String dir, String voaId) {
        String fileNameWithoutSuffix = getVideoNameFromClip(voaId);
        String fileNameWithSuffix = getVideoFilename(fileNameWithoutSuffix);
        new File(dir, fileNameWithSuffix).delete();
    }

    public static String getVideoClipExist(String voaId) {
        String fileNameWithoutSuffix = getVideoNameFromClip(voaId);
        String fileNameWithSuffix = getVideoFilename(fileNameWithoutSuffix);
    ...
    private static String getVideoNameFromClip(String videoUrl) {
        Timber.d("video"+videoUrl);
        String result = videoUrl.substring(videoUrl.lastIndexOf(File.separator)+1,videoUrl.lastIndexOf("."));
        return result;
    }

    public  static String getImageZipName(String bookid) {
        return "tmp" + bookid + ".zip";
    }

    public static String getVideoClipTempilename(String url) {
        return  "tmp"+getVideoFilename(getVideoNameFromClip(url));
    }
}
