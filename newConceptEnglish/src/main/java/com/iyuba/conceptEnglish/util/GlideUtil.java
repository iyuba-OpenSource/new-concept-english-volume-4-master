...
//
//    //刷新文章图片
//    public static void setFreshImage(String imageUrl, Context mContext,int placeImage, ImageView imageView){
//
//        Glide.with(mContext).load(imageUrl)
//                .asBitmap()
//                .signature(new StringSignature(new Date().getTime() +"")) //加载同一url
//                .placeholder(placeImage)
//                .error(placeImage)
//                .dontAnimate()  //防止加载网络图片变形
//                .into(imageView);
