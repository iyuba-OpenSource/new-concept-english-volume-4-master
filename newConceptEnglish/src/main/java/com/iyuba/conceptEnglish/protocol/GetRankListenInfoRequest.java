...
//        String sign = URLEncoder.encode(uid + type + start + total + date);
        ...
        setAbsoluteURI("http://daxue." + Constant.IYUBA_CN + "ecollege/getStudyRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
                ...
                "&mode=" +
                mode);
        Log.e("GetRankListenInfoRequest", "http://daxue." + Constant.IYUBA_CN + "ecollege/getStudyRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
