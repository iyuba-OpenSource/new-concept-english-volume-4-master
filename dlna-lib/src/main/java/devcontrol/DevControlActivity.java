...
//                controlPointView.setVolume(current);
    ...
    private void initView(){
        ...
        volumnImg = findViewById(R.id.volumn_img);
    }
    ...
    private void showVolumnView() {
        ...
        if (current_volume <= 0) {
            volumnImg.setImageDrawable(getResources().getDrawable(R.drawable.volumn_silent));
        }else {
            volumnImg.setImageDrawable(getResources().getDrawable(R.drawable.volume_up));
        }
    ...
    public void onStopClicked() {
        ...
        finish();
        Log.d("退出显示2", this.getClass().getName());
    }
        ...
        switch (requestCode) {
            case REQ_CHOOSE_DEVICE:
                if (resultCode == RESULT_OK) {
                    ...
                    finish();
                    Log.d("退出显示3", this.getClass().getName());
                }
                break;
        }
    }
